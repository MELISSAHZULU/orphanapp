...
@Composable
fun PendingVerificationScreen(navController: NavController, orphanList: List<Orphan>) {
    Scaffold(
        topBar = {
            TopAppBar(
        ...
        if (orphanList.isEmpty()) {
            Column(
                ...
                Text("No orphans are currently pending verification.")
            }
        } else {
            LazyColumn(
                modifier = Modifier
                ...
                items(orphanList) { orphan ->
                    Card(
                        ...
                        Row(modifier = Modifier.padding(16.dp)) {
                            ...
                            Text(orphan.status, color = Color.Gray)
                        }
                    }
                }
            }
